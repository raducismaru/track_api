"""
Django settings for track_api project.
...
SECRET_KEY = 'q)^wpy=unv$3q5h*sgwp&cd@ko=)mj!4r$=kzsmomm1_&o==2p'
...
WSGI_APPLICATION = 'track_api.wsgi.application'
